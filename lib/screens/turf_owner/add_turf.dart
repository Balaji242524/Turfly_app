            ...
            Expanded(
              child: SingleChildScrollView(
                ...
                child: Form(
                  ...
                  child: Column(
                    children: [
                      buildInputField(icon: Icons.edit, hint: 'Enter your Turf Name', controller: _turfNameController),
                      GestureDetector(
                        onTap: pickFiles,
                        child: Container(
                      ...
                      if (uploadedFiles.isNotEmpty)
                        Wrap(
                          spacing: 8,
                          children: uploadedFiles.map((url) => Chip(label: Text("Image Uploaded"))).toList(),
                        ),
                      GestureDetector(
                        onTap: () async {
                        ...
                        child: Container(
                          ...
                          child: ListTile(
                            ...
                            title: Text(
                              ...
                              style: TextStyle(color: pickedLocation == null ? Colors.grey : Colors.black),
                            ),
                          ),
                        ),
                      ),
